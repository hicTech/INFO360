			              ...
			              html+='</div>'+
								...
								'<ul class="latestpost">'+
									'<li>'+
										...
										'<h4>Indirizzo: <a  rel="bookmark" >'+indirizzo+'</a></h4><div style="width:645px">'+descrizione+'</div>'+
			...
			function pageNavigatorAttivitaCategoria(arr){
				$.each(arr,function(index,value){
					...
					var html_tasto_home='<a class="button_home button_attivita">'+value.toLowerCase()+'</a>';
		...
		function mostraDettaglioAttivita(el){
			...
			function pageNavigatorEventiCitta(arr){
				$.each(arr,function(index,value){
					...
					var html_tasto_home='<a class="button_home button_eventi">'+value.toLowerCase()+'</a>';
