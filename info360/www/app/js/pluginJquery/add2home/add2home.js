 ...
 */
/**
 * note marco: nell bootstrap ho commentato i listner load() e ready()
 * che vengono invece invocate alla fine
 * visto che showAdd2Home() viene invoacata da appML quando è tutto pronto!  
 */

function showAdd2Home(){
	/////add2home.css import	
	var headID = document.getElementsByTagName("head")[0];         
	var cssNode = document.createElement('link');
	cssNode.type = 'text/css';
	cssNode.rel = 'stylesheet';
	cssNode.href = 'js/plugins/add2home/add2home.css?v2';
	cssNode.media = 'screen';
	headID.appendChild(cssNode);
	/////end add2home.css import
...
(function(){
		var nav = navigator,
			...
			options = {
				...
				lifespan: 7000,			// 20 seconds before it is automatically destroyed
